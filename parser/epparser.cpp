...
#line 91 "parser\\epparser.lemon"
{
    ...
    ps->gen << "import " << impPathProcess(yymsp[0].minor.yy0->data) << " as " << yymsp[0].minor.yy0->data << std::endl;
...
#line 669 "parser\\epparser.lemon"
{
...
#line 761 "parser\\epparser.lemon"
