...
#line 228 "parser/epparser.lemon"
{
    ...
    const char *p = yymsp[-3].minor.yy0->data.c_str(), *p2 = p;
    while(1) {
        while(*p2 != '\0' && *p2 != ',') p2++;
        std::string varname(p, p2 - p);
