...
std::unordered_set<std::string> builtinConstSet = {
        ...
        "Score", "SeqCompute", "Set", "SetAllianceStatus", "SetCountdownTimer",
        "SetCurrentPlayer", "SetDeaths", "SetDoodadState", "SetInvincibility",
        "SetMemory", "SetMemoryEPD", "SetMissionObjectives", "SetNextPtr",
        "SetNextScenario", "SetResources", "SetScore", "SetSwitch", "SetTo",
        "SetVariables", "Subtract", "Switch", "TBL", "TalkingPortrait", "Toggle",
        "Total", "Transmission", "TrigTriggerBegin", "TrigTriggerEnd", "Trigger",
        "UnMuteUnitSpeech", "UnitProperty", "Units", "UnitsAndBuildings",
        "UnpauseGame", "UnpauseTimer", "VProc", "Victory", "Wait",
        "afterTriggerExec", "b2i1", "b2i2", "b2i4", "b2u", "beforeTriggerExec",
        "cachedfunc", "ep_assert", "epsCompile", "eudplibVersion", "f_atan2",
        "f_bitand", "f_bitlshift", "f_bitnand", "f_bitnor", "f_bitnot",
        "f_bitnxor", "f_bitor", "f_bitrshift", "f_bitsplit", "f_bitxor",
        "f_blockpatch_epd", "f_bread", "f_bwrite", "f_dbstr_adddw",
