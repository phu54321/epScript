...
std::unordered_set<std::string> builtinConstSet = {
    ...
    "f_bread", "f_bwrite", "f_dbstr_adddw", "f_dbstr_addptr",
    "f_dbstr_addstr", "f_dbstr_print", "f_div", "f_dwadd_cp", "f_dwadd_epd",
    "f_dwbreak", "f_dwbreak2", "f_dwepdread_cp", "f_dwepdread_epd",
    "f_dwepdread_epd_safe", "f_dwpatch_epd", "f_dwrand", "f_dwread",
    "f_dwread_cp", "f_dwread_epd", "f_dwread_epd_safe", "f_dwsubtract_cp",
    "f_dwsubtract_epd", "f_dwwrite", "f_dwwrite_cp", "f_dwwrite_epd",
    "f_epdread_cp", "f_epdread_epd", "f_epdread_epd_safe", "f_flagread_epd",
    "f_getcurpl", "f_getseed", "f_getuserplayerid", "f_initextstr",
    "f_lengthdir", "f_memcpy", "f_mul", "f_playerexist", "f_rand",
    "f_randomize", "f_repmovsd_epd", "f_setcurpl", "f_simpleprint", "f_sqrt",
    "f_srand", "f_strcmp", "f_strcpy", "f_unpatchall", "f_wread", "f_wwrite",
    "find_data_file", "hptr", "i2b1", "i2b2", "i2b4", "isStrict",
    "isUnproxyInstance", "onPluginStart", "selftype", "setStrict", "settings",
    "u2b", "unProxy",
};
