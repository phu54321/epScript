...
std::unordered_set<std::string> builtinFuncSet = {
        ...
        "Draw", "EPD", "EPError", "EPSFinder", "EPSLoader", "EUDAnd", "EUDArray",
        "EUDBinaryMax", "EUDBinaryMin", "EUDBranch", "EUDBreak", "EUDBreakIf",
        "EUDBreakIfNot", "EUDByteReader", "EUDByteWriter", "EUDClearNamespace",
        "EUDContinue", "EUDContinueIf", "EUDContinueIfNot", "EUDCreateBlock",
        ...
        "EUDExecuteOnce", "EUDFunc", "EUDFuncN", "EUDFuncPtr", "EUDGetBlockList",
        ...
        "KillUnit", "KillUnitAt", "Kills", "LeaderBoardComputerPlayers",
        ...
        "PRT_SetInliningRate", "PRT_SkipPayloadRelocator", "PTrigger",
        "PauseGame", "PauseTimer", "PlayWAV", "PopTriggerScope",
