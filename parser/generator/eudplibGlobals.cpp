...
std::unordered_set<std::string> builtinConstSet = {
        ...
        "LowestScore", "MPQAddFile", "MPQAddWave", "MapLocation", "MapString",
        "MapSwitch", "MapUnit", "Memory", "MemoryEPD", "MinimapPing",
        "ModifyUnitEnergy", "ModifyUnitHangarCount", "ModifyUnitHitPoints",
        "ModifyUnitResourceAmount", "ModifyUnitShields", "MostKills",
        "MostResources", "Move", "MoveLocation", "MoveUnit", "MuteUnitSpeech",
        "NeutralPlayers", "Never", "NextTrigger", "NonAlliedVictoryPlayers",
        "Opponents", "Order", "Ore", "OreAndGas", "P1", "P10", "P11", "P12", "P2",
        "P3", "P4", "P5", "P6", "P7", "P8", "P9", "PRT_SetInliningRate",
        "PRT_SkipPayloadRelocator", "PTrigger", "Patrol", "PauseGame",
        "PauseTimer", "PlayWAV", "Player1", "Player10", "Player11", "Player12",
        "Player2", "Player3", "Player4", "Player5", "Player6", "Player7",
        "Player8", "Player9", "PopTriggerScope", "PreserveTrigger",
        ...
        "Toggle", "Total", "Transmission", "TrigTriggerBegin", "TrigTriggerEnd",
        "Trigger", "UnMuteUnitSpeech", "UnitProperty", "Units",
        "UnitsAndBuildings", "UnpauseGame", "UnpauseTimer", "VProc", "Victory",
        "Wait", "afterTriggerExec", "b2i1", "b2i2", "b2i4", "b2u",
        "beforeTriggerExec", "cachedfunc", "ep_assert", "epsCompile",
        ...
        "f_unpatchall", "f_wread", "f_wwrite", "find_data_file", "hptr", "i2b1",
        "i2b2", "i2b4", "isStrict", "isUnproxyInstance", "onPluginStart",
        "selftype", "setStrict", "settings", "u2b", "unProxy",
};
